USE [master]
GO
/****** Object:  Database [Demo]    Script Date: 5/6/2023 12:55:15 PM ******/
CREATE DATABASE [Demo]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Demo', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLDUCTHANH\MSSQL\DATA\Demo.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Demo_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLDUCTHANH\MSSQL\DATA\Demo.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
GO
ALTER DATABASE [Demo] SET ANSI_NULL_DEFAULT ON 
GO
ALTER DATABASE [Demo] SET ANSI_NULLS ON 
GO
ALTER DATABASE [Demo] SET ANSI_PADDING ON 
GO
ALTER DATABASE [Demo] SET ANSI_WARNINGS ON 
GO
ALTER DATABASE [Demo] SET ARITHABORT ON 
GO
...
GO
ALTER DATABASE [Demo] SET CURSOR_DEFAULT  LOCAL 
GO
ALTER DATABASE [Demo] SET CONCAT_NULL_YIELDS_NULL ON 
GO
ALTER DATABASE [Demo] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Demo] SET QUOTED_IDENTIFIER ON 
GO
...
USE [Demo]
GO
/****** Object:  Table [dbo].[Category]    Script Date: 5/6/2023 12:55:15 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Product]    Script Date: 5/6/2023 12:55:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 5/6/2023 12:55:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
